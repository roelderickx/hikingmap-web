...
<body>
    ...
    <form action="hikingmap.php" method="post" enctype="multipart/form-data">
        <fieldset>
            ...
            <td>
                <input type="checkbox" id="waypoints" name="waypoints" value="true" checked/>
            </td>
            <td>
                <label for="waypointsdist">every</label>
                <input type="text" id="waypointsdist" name="waypointsdist" value="1" size="2"/>
